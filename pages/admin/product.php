...
<body class="bg-light">
    ...
    <!-- Product loader -->
    <script type="module" src="../../scripts/product_loader.js"></script>
    <!-- Admin controller  -->
    <script type="module" src="../../scripts/admin_data/admin_controller.js"></script>
    <!-- Product page for admin controller -->
    <script type="module" src="../../scripts/admin_data/product_controller.js"></script>
